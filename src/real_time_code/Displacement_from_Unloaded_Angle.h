...
struct ModelData {
    ...
    // New output:
    // Integral controller gain = delta_x / delta_theta2
    ...
    double Desired_angle)
{
    ...
    const double Kd = curvature_factor * (1.0 / (Rd + t / 2.0));
    const double Md =
    ...
    // ----------------------------------------------------
    // Find phase boundary for S1 using d_S1
    // ----------------------------------------------------
    ...
    // ----------------------------------------------------
    // Find phase boundary for theta_1 using d_theta
    // ----------------------------------------------------
    ...
    // ----------------------------------------------------
    // Moment, curvature, springback, unloaded angle, force
    // ----------------------------------------------------
